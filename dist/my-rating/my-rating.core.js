...
((w,d,x,n,h,c,r)=>{((s)=>{s&&(r=s.getAttribute('data-resources-url'))})(d.querySelector("script[data-namespace='my-rating']"));
/**
 * SSR Attribute Names
 */
...
})(window,document,{},"MyRating","hydrated",[["my-rating","my-rating",1,[["maxValue",1,0,"max-value",8],["starList",16],["value",2,0,1,8]],1]]);